...
public class UserUtility {
    ...
    public static Map<String, String> getUserCredentials(String role, String location) {
        // point to the correct file path based on location argument, we
        String file = null;
        switch (location) {
        ...
        for (Map<String, String> user : userData) {
            if (role.contains(user.get("role"))) {
                ...
                //excel has not password, but according to rule password first name and last name
    ...
    public static void main(String[] args) {
        System.out.println(getUserCredentials(ApplicationConstants.STUDENT_TEAM_LEADER, ApplicationConstants.DARK_SIDE));
